...
object HuaweiPodsAction {
    ...
    const val EXTRA_FREECLIP2_FEATURE = "freeclip2_feature"
    const val EXTRA_FREECLIP2_FEATURE_ENABLED = "freeclip2_feature_enabled"
    const val EXTRA_FREECLIP2_FEATURE_SUCCESS = "freeclip2_feature_success"
    const val EXTRA_FREECLIP2_FEATURE_RESULT_RECEIVER = "freeclip2_feature_result_receiver"
